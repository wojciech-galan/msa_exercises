...
1.1. Możesz łatwo ocenić, jak szybko działa program do tworzenia dopasowań. Ale czy te dopasowania zostały utworzone prawidłowo? Aby to sprawdzić, skorzystaj z bazy dopasowań referencyjnych BAliBASE. W zbiorze dopasowań referencyjnych 1.2 znajduje się dopasowanie o takim samym identyfikatorze, jak Twój zbiór sekwencji, czyli %s. Skorzystaj z programu bali_score, aby porównać dopasowania utworzone przez Ciebie z dopasowaniem referencyjnym. Czy wyniki uzyskane różnymi programami różnią się znacznie od siebie?
